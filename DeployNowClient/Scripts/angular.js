      ...
      NUMBER_FORMATS: {
        ...
        PATTERNS: [
          { // Decimal Pattern
            ...
            posPre: '\u00A4',
            posSuf: '',
            negPre: '\u00A4-',  // for negative  numbers display behaviour is changed
            negSuf: '',
            gSize: 3,
            lgSize: 3
          }
...
forEach(
  'click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress blur'.split(' '),
  function(name) {
